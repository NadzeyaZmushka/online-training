...
public class UserDaoImpl implements UserDao {
    ...
    //    private static final String FIND_USER_BY_ID = "SELECT id, user_name, user_surname, user_email, user_role " +
//            "FROM training.users " +
//            "WHERE id = ?";
    private static final String FIND_USER_BY_EMAIL_SQL = FIND_ALL_USERS_SQL + " WHERE user_email = ?";
    //private static final String FIND_USER_BY_EMAIL = "SELECT id, user_name, user_surname, user_email, user_role " +
//        "FROM training.users " +
//        "WHERE user_email = ?";
